...
ActiveRecord::Schema[7.0].define(version: 2022_11_03_113349) do
  ...
  create_table "accountants", force: :cascade do |t|
    ...
    t.index ["confirmation_token"], name: "index_accountants_on_confirmation_token", unique: true
    ...
    t.index ["unlock_token"], name: "index_accountants_on_unlock_token", unique: true
  end
  ...
  create_table "laboratories", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["confirmation_token"], name: "index_laboratories_on_confirmation_token", unique: true
    ...
    t.index ["unlock_token"], name: "index_laboratories_on_unlock_token", unique: true
  end
  ...
  create_table "pharmacies", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["confirmation_token"], name: "index_pharmacies_on_confirmation_token", unique: true
